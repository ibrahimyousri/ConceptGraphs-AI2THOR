...
## This fork contains configurated ConceptGraphs for the object rearrangement task in AI-2THOR, specifically to be used by [this repository](https://github.com/ibrahimyousri/object-rearrangement).
